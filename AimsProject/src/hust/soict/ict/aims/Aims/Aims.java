...
public class Aims {
    ...
    public static void cartOption() throws CartFullException{
        int choice;
        do {
            cartMenu();
    ...
    public static void detailOption(Media chosenMedia) throws  CartFullException {
        int choice;
        do {
            mediaDetailsMenu();
    ...
    public static void seeAMediaDetail(Media searchTitle) throws CartFullException, CartFullException {
        int choice;
        do {
            mediaDetailsMenu();
    ...
    public static void choosingOption() throws CartFullException, CartFullException {
        int choice;
        do {
            storeMenu();
            System.out.print("Your choice is: ");
    ...
    public static void updateOption() throws CartFullException, CartFullException {
    ...
    public static void menuOption() throws CartFullException, CartFullException {
        int choice;
        do {
            showMenu();
            System.out.print("Your choice is: ");
    ...
    public static void main(String[] args) throws CartFullException, CartFullException {
